...
effnet_path = '/home/roni/רוני/Data_Science/Kaggle/Cassava Leaf Disease Classification/ReSNets/'
...
class FineTuneModel(nn.Module):3
...
model     = FineTuneModel(original_model=resnest50(), num_classes=5).to(device) 
